" note: using this instead of vanilla yaml syntax file that comes with Vim 7
" which is unbearably slow, cf. https://github.com/stephpy/vim-yaml
"
...
syn region yamlLiteralBlock start='|\n\z\(\s\+\)'rs=s+2,hs=s+2,ms=s+2 skip='^\s*$' end='^\z1\@!'
